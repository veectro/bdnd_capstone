...
contract ERC721 is Pausable, ERC165 {
    ...
    function balanceOf(address owner) public view returns (uint256) {
        ...
        require(owner != address(0), "ERC721: Owner is the zero address");
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != ownerOf(tokenId), "ERC721: Given address can not be the owner of the tokenId");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == getOwner() || isApprovedForAll(msg.sender, to), "ERC721: Sender must be the owner or sender is approved");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == ownerOf(tokenId), "ERC721: from is not token owners");

        // TODO: require token is being transfered to valid address
        require(to != address(0), "ERC721: Invalid destination address");
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function setTokenURI(uint256 tokenId) internal {
        require(_exists(tokenId), "ERC721Metadata: tokenId does not exists");
